# Chapter 93: Multi-Task Learning для Trading

## Описание

Одновременное обучение нескольким связанным торговым задачам.
...
1. **Multi-Task Learning for Financial Prediction**
   - URL: https://arxiv.org/abs/2012.07716
   - Год: 2020
